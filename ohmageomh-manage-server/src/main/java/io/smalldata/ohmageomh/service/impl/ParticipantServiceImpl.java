...
public class ParticipantServiceImpl implements ParticipantService{
    ...
    public ParticipantServiceImpl(ParticipantRepository participantRepository, ParticipantSearchRepository participantSearchRepository) {
    ...
    public Page<Participant> search(String query, Pageable pageable) {
        ...
        Page<Participant> result = participantSearchRepository.search(queryStringQuery(query), pageable);
        return result;
    }
}
